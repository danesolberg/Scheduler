...
public class AddCustomerController implements Initializable {
    ...
    /**
     * Saves the current customer to the connected repository
     * @param event
     * @throws IOException
     */
    @FXML
    ...
    private void handleCountrySelection(ActionEvent event) {
        /**
         * This method filters the first-level divisions list based on the selected
         * country in the countryComboBox. A lambda expression was used in the filter()
         * intermediate stream operator to filter each division based on its country
         * without creating a named separate function to use within filter().
         */
